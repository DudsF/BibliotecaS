...
<title>Emprestimos aberto</title>
</head>
<body>
<style>
...
<table id="customers">
		...
		<tbody>
			<c:forEach var="emprestimo" items="${emp }">
				<tr>
        ...
        pattern="dd/MM/yyyy" /> </td>
					...
					<td><a href="/ProjetoBiblioteca3/emprestimos/devolucao?id=${emprestimo.id}">devolver</a></td>
